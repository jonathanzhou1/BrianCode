...
public class ObjectManager 
{
    ...
    {
        gm.obj[0] = new Phone();
        gm.obj[0].worldX = 31 * gm.tileSize;
        gm.obj[0].worldY = 2 * gm.tileSize;
        ...
        gm.obj[3] = new Phone();
        gm.obj[3].worldX = 27 * gm.tileSize;
        gm.obj[3].worldY = 42 * gm.tileSize;
        
        gm.obj[4] = new Phone();
        gm.obj[4].worldX = 8 * gm.tileSize;
        gm.obj[4].worldY = 45 * gm.tileSize;
        ...
        gm.obj[6].worldY = 33 * gm.tileSize;
    }
}
