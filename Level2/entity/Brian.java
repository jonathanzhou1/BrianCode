...
public class Brian extends Entity
{
    ...
    public void draw(Graphics2D g2)
    {
        ...
        int rightOffset = gm.screenWidth - screenX;
        if (rightOffset > gm.worldWidth - worldX)
        {
            x = gm.screenWidth - (gm.worldWidth - worldX);
        }
        int bottomOffset = gm.screenHeight - screenY;
        if (bottomOffset > gm.worldHeight - worldY)
        {
            y = gm.screenHeight - (gm.worldHeight - worldY);
        }
